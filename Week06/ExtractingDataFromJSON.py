...
and the other is the actual data you need to process for the assignment.
    ...
    Actual data: http://py4e-data.dr-chuck.net/comments_308892.json (Sum ends with 44)
...
# Decode html and list number of items in JSON file
data = json.loads(html)
print('Count:', len(data['comments']))

count = 0

# Calculate the total of the 'count' items in the JSON filexz 
for number in data['comments'] :
    count = count + int(number['count'])
